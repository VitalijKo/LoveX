...
class SocketHandler:
    ...
    def ping(self, room_id, is_away=True):
        self.send({
            'action': 'pingRoom',
            'room_id': room_id,
            'is_away': is_away
...
class Callbacks:
    ...
    def warns_change(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def access_denied(self, data):
        return True

    def new_guest(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])
    ...
    def server_will_reboot(self, data):
        return True

    def update_room_gifts(self, data):
        self.call(getframe(0).f_code.co_name, data['2']['1'])

    def admin_review_photo(self, data):
        return True

    def add_photos(self, data):
        return True

    def change_state(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def user_add_to_favorite(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def user_remove_from_favorite(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def admin_reject_photo(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def new_private_message(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def change_balance(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])

    def update_freq_gifts(self, data):
        self.call(getframe(0).f_code.co_name, data['2'])
